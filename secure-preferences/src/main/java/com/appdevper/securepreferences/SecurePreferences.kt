package com.appdevper.securepreferences
...
class SecurePreferences private constructor(
    ...
    class Builder(private val context: Context) {
        ...
        fun build(): SharedPreferences {
            ...
            val entity = Entity.create(if (TextUtils.isEmpty(password)) javaClass.getPackage()!!.name else password)
    ...
    constructor() : SharedPreferences.Editor {
        ...
        override fun putInt(key: String, value: Int): SharedPreferences.Editor {
            mEditor.putString(hashKey(key), encrypt(Integer.toString(value)))
            return this
        }

        override fun putLong(key: String, value: Long): SharedPreferences.Editor {
            mEditor.putString(hashKey(key), encrypt(java.lang.Long.toString(value)))
            return this
        }

        override fun putFloat(key: String, value: Float): SharedPreferences.Editor {
            mEditor.putString(hashKey(key), encrypt(java.lang.Float.toString(value)))
            return this
        }
